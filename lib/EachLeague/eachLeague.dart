                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text('الدوري الاسباني'.tr, style: head)
                      ],
                    ),
                  ),
                ],
        ...
        body: SafeArea(
          child: NestedScrollView(
            ...
            body: new TabBarView(controller: tabController, children: [
              ...
              ListView(children: <Widget>[matchesForLeague()]),
              ListView(children: <Widget>[leagueNews()]),
              ListView(
              ...
              ListView(children: <Widget>[playersStats()]),
              ListView(children: <Widget>[teamsStats()]),
            ]),
          ),
        ),
      ),
