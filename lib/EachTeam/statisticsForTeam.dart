        ...
        child: ExpansionTile(
          title: Row(children: <Widget>[
            ...
            Column(crossAxisAlignment:CrossAxisAlignment.start,children: <Widget>[
              Row(children: <Widget>[Text("الدوري الاسباني الدرجه الاولي".tr,style: head,)],),
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          Container(height: 128,width: MediaQuery.of(context).size.width*0.49,
              ...
              child:Padding(
                ...
                child: Column(
                  children: <Widget>[
                  Row(children: <Widget>[Text("تقيم اللاعب".tr,style: head,)],),
          ...
          Container(height: 128,width: MediaQuery.of(context).size.width*0.49,
              ...
              child:Padding(
                ...
                child: Column(children: <Widget>[
                  Row(children: <Widget>[Text("فريق مقابل فريق".tr,style: content)],),
                  Row(children: <Widget>[Text("مقارنة الاحصائيات".tr,style: content4)],),
                  SizedBox(height: 10,),
                  Row(
                    children: <Widget>[
            ...
            child: Padding(padding: EdgeInsets.only(top: 8,bottom: 8,right: 10),
              child: Column(children: <Widget>[
                Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                    Text("النقاط".tr,style: content,),Text("69",style: number,)],),
                ),
                Row(children: <Widget>[Text("الرتبه 1".tr,style: content2,)],),
                Divider(height: 20,),
                Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Column(crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                        Text("اللعب المفتوح".tr,style: content,),Text("ركنية".tr,style: content,)
                          ,Text("ضربة حرة".tr,style: content,),Text("ضربة جزء".tr,style: content,),Text("هدف في مرماه".tr,style: content,),
                      ],),
                    /*
                    Column(
          ...
          Container(
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                  Row(children: <Widget>[Text("بطاقات".tr)],),
                  Padding(
