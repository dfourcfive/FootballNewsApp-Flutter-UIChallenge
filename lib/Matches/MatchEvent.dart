  ...
  Widget build(BuildContext context) {
                  ...
                  child: Column(children: <Widget>[
                    Padding(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            Text("لم يخسر ريال مدريد في 8 مقابلات".tr),]),
                    ),
                    Divider(height: 2.0,),
                            ...
                            child: Column(children: <Widget>[
                              Padding(
                                ...
                                child: Row(children: <Widget>[
                                  Text("من تعتقد سيفوز؟".tr,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 15))
                                ],),
                              ),
                              Padding(
                            ...
                            child: Container(color: Colors.white,
                              child: Column(children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: Text("اجمالي الاصوات:188".tr,
                                ...
                                children: <Widget>[
                                  Container(
                                    width: MediaQuery.of(context).size.width * 0.9,
                                      child: Text("ريال مدريد معدل 1 اهداف في اخر 3 مقابلات،وا اتليتكو لديه معدل 0.67".tr,overflow: TextOverflow.visible,)),]),
                          ),
                          Divider(height: 2.0,),
                                ...
                                Container(
                                  child: Column(children: <Widget>[
                                    Padding(
                                      padding: const EdgeInsets.all(10.0),
                                      child: Row(children: <Widget>[
                                        Text("هل يسجل الفريقان نتائج؟".tr,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 15))
                                      ],),
                                    ),
                                    Padding(
                    ...
                    Padding(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[Container(
                            width: MediaQuery.of(context).size.width * 0.9,
                              child: Text("ريال مدريد معدل 1 اهداف في اخر 3 مقابلات،وا اتليتكو لديه معدل 0.67".tr,
                          ...
                          Container(
                            child: Column(children: <Widget>[
                              Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Row(children: <Widget>[
                                  Text("هل سيكون هناك اكثر من 2.5 هدفا؟".tr,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 15))
                                ],),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                          ...
                          Visibility(
                            ...
                            child: Container(
                              ...
                              child: Column(children: <Widget>[
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(top: 12),
                                  child: Text("اجمالي الاصوات:14".tr,
                                    style: TextStyle(color: Colors.grey[500],fontSize: 13),),
                                ),
                                SizedBox(height: 15,),
                                Divider(height: 2,)
                  ...
                  child: Column(children: <Widget>[
                    Padding(
                      ...
                      child: Row(
                          mainAxisAlignment:MainAxisAlignment.start,
                          children: <Widget>[
                            Text("اتليتكو".tr,style: TextStyle(fontWeight: FontWeight.w600),),
                            Text(" لم يتعادل في اخر  8 مقابلات".tr),]),
                    ),
                    Divider(height: 2.0,),
                          ...
                          Container(
                            ...
                            child: Column(children: <Widget>[
                              Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Row(children: <Widget>[
                                  Text("فرصه مضاعفة".tr,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 15))
                                ],),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                            ...
                            child: Container(
                              ...
                              child: Column(children: <Widget>[
                                Padding(
                                  padding: const EdgeInsets.all(10.0),
                                  child: Row(children: <Widget>[
                                    Text("فرصة مضاعفة؟".tr,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 15))
                                  ],),
                                ),
                                Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,children: <Widget>[
                                  Padding(
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(top: 12),
                                  child: Text("اجمالي الاصوات:7".tr,
                                    style: TextStyle(color: Colors.grey[500],fontSize: 13),),
                                ),
                                SizedBox(height: 15,),
                                Divider(height: 2,)
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Row(mainAxisAlignment:MainAxisAlignment.start,
                    children: <Widget>[
                      Text("تاريخ المبارة".tr),
                      SizedBox(width: 50,),
                      Text("الخميس،3 سبتمبر 2020 3:30 م".tr)
                    ],),
                ),
                Padding(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Center(child: Padding(
                            ...
                            child: Text("الدوري الاسباني-الشوط 24".tr,maxLines: 2,softWrap: true,),
                          )),
                        )
                      ],),
                  ),
    ...
    BorderRadius.all(Radius.circular(10.0))),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: <Widget>[
                      Container(
                        ...
                        child: Center(child: Text("ف".tr,style: TextStyle(color: Colors.white),)),
                      ),
                      Container(
                        height: 26,
                        width: 30,
                      ...
                      Container(
                        ...
                        child: Center(child: Text("ت".tr,style: TextStyle(color: Colors.white),)),
                      ),
                      Container(
                        height: 26,
                        width: 30,
      ...
      child: Padding(
        ...
        child: Column(
          children: <Widget>[
            Row(mainAxisAlignment:MainAxisAlignment.start,children: <Widget>[Text("ترقيات الصعاب هي 18+.".tr),],),
            Row(mainAxisAlignment:MainAxisAlignment.start,children: <Widget>[Text("اقرا المزيد علي".tr)],)
