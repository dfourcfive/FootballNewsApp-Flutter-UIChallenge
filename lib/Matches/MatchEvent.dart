                            ...
                            child: Column(
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Text("هل سيكون هناك اكثر من 2.5 هدفا؟".tr,
                                          style: TextStyle(
                                              fontWeight: FontWeight.w600,
                                              fontSize: 15))
                                    ],
                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        Text(
                                            "هل سيكون هناك اكثر من 2.5 هدفا؟"
                                                .tr,
                                            style: TextStyle(
                                                fontWeight: FontWeight.w600,
                                                fontSize: 15))
          ...
          child: Column(
            children: <Widget>[
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
                  Text("ترقيات الصعاب هي 18+.".tr),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[Text("اقرا المزيد علي".tr)],
              )
            ],
          ),
        ),
