                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text(
                              "اللاعبون المصابون والمطردون".tr,
                              style: TextStyle(fontSize: 17),
                            ),
                          ],
                        ),
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Text("تسديدات بعيد عن المرمي".tr,
                                  style: _textStyle2),
                              Text("تسديدات في المرمي".tr, style: _textStyle2),
                              Text("التسديدات التي تم صدها".tr,
                                  style: _textStyle2),
                              Text("تسديدات  علي العارضة".tr,
                                  style: _textStyle2),
                              Text("التسديدات داخل منطقة الجزاء".tr,
                                  style: _textStyle2),
                              Text("التسديدات خارج منطقة الجزاء".tr,
                                  style: _textStyle2),
                            ],
                          ),
                          Column(
