          ...
          child: Row(
            children: [
              Container(
                  width: 35,
                  height: 30,
                  child: Image.asset(leaguen[index].img)),
              SizedBox(
                width: 10,
              ),
              Text(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          left: 70, right: 35, bottom: 13),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(
                            leaguedetails[index].childern[0].firstTeam,
                            style: content,
                          ),
                          Container(
                            width: 30,
                            height: 25,
                            child: Image.asset(
                                leaguedetails[index].childern[0].urlFirst),
                          ),
                          SizedBox(
                            width: 8,
                          ),
                          Center(
                              child: Text(
                            leaguedetails[index].childern[0].time,
                            style: content,
                          )),
                          SizedBox(width: 12),
                          Container(
                          ...
                          Text(
                            leaguedetails[index].childern[0].seconTeam,
                            style: content,
                          ),
                        ],
                      ),
